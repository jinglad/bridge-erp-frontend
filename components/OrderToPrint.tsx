...
export const OrderToPrint = forwardRef<HTMLInputElement, OrderToPrintProps>(
  ({ customer, paid, discount, payment_method, products, to_be_paid, createdDate }, ref) => {
    return (
      ...
      >
        <Box sx={{ fontSize: "8px !important" }}>নিউ আমজাদিয়া ভান্ডার</Box>
        <Box sx={{ fontSize: "8px !important" }}>০১৮৭২৫০০৬৪৫ , ০১৭০৯২০২৫৮১</Box>
        <Box sx={{ fontSize: "8px !important" }}>{customer}</Box>
        <DoubleDivider />
